                  ...
                  <div class="accordion-body">
                    <div class="sg-table table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                        <tr v-for="(cart,index) in carts" :key="index" v-if="seller_id == cart.seller_id">
                          <th scope="row">
                            <div class="product">
                              <router-link :to="{name: 'product.details',params: {slug:cart.product_slug}}">
                                ...
                                <div class="text">
                                  ...
                                  <span v-if="cart.sku">{{ lang.SKU }}: {{cart.sku}}</span>
                                </div>
                              </router-link>
                            </div>
                          </th>
          ...
          <div class="col-lg-4 pl-lg-5">
            <div class="order-summary">
              ...
              <div class="sg-card">
                ...
                ></payment_details>
                <a href="javascript:void(0)" @click="handleCheckout" class="btn btn-primary">{{ lang.proceed_to_checkout }}</a>
              </div>
            </div>
          </div>
        </div><!-- /.row -->
