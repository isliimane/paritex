            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tr v-for="(order_detail, index) in order.order_details" :key="'order' + index">
                  ...
                  <td class="text-end">{{ priceFormat(order_detail.total_amount) }}
                  </td>
                ...
                <table class="table text-start">
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="global-list">
                        <li>{{ order.date }}</li>
                        <li v-if="addons.includes('ramdhani') && order.delivery_date">{{ order.delivery_date }}</li>
                  ...
                  <div class="order-summary">
                    <div class="sg-card">
                      <ul class="global-list">
                        ...
                        <li v-if="(order.tax_type == 'before_tax' || order.vat_tax_type == 'product_base') || (order.total_tax > 0 && addons.includes('ramdhani'))">{{ lang.tax }}
  ...
  methods: {
    ...
    refundModal(order_detail, index) {
      ...
      if (this.settings.refund_with_shipping_cost) {
        this.form.refundable_amount = this.priceFormat(order_detail.price + order_detail.shipping_cost.total_cost );
      } else {
