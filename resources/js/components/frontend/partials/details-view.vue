            ...
            <div class="product-details-2">
              ...
              <div class="product-details-totalPrice product-border">
                <div class="count-quantity" data-trigger="spinner">
                  ...
                  <input type="text" name="quantity" @focusout="quantityCheck" v-model="product_form.quantity"
                ...
                <div class="product-cart sg-quantity">
                  <div class="buttons d-flex align-items-center">
                    <a href="javascript:void(0);" class="btn btn-primary"
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="42" height="42">
                        <path
                  ...
                  <ul class="global-list d-flex">
                    ...
                    <li v-if="authUser && productDetails.user_wishlist">
                      <a @click="removeWishlist" href="javascript:void(0)">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Filled" viewBox="0 0 24 24" width="512"
                             height="512">
                          <path
              ...
              <div class="social-media-icon">
                <ul class="global-list d-flex">
                  ...
                  <li class="ld-icon"
                  ><a target="_blank"
                      :href="'https://www.linkedin.com/sharing/share-offsite?mini=true&url=' + getUrl('product/' + productDetails.slug) + '&title=' + productDetails.product_name + '&summary=Extra+linkedin+summary+can+be+passed+here'"
                  ><span class="mdi mdi-linkedin"></span></a
                  ></li>
                  <li class="wh-icon"
                  ><a target="_blank" :href="'https://wa.me?text=' + getUrl('product/' + productDetails.slug)"><span
                      class="mdi mdi-name mdi-whatsapp"></span></a
                  ></li>
                </ul>
              </div>
            </div>
        ...
        <div class="products-description product-details-description">
          <ul class="nav nav-tabs description-tabs" role="tablist">
            <li role="presentation" class="nav-item">
              <a class="nav-link" :class="{ active: activeNav == 'details' }" href="javascript:void(0)"
                 @click="activeNav = 'details'" aria-controls="details" role="tab" data-bs-toggle="tab">
                {{ lang.details }}
              </a>
            </li>
            <li class="nav-item" role="presentation"
                v-if="productDetails.language_product && productDetails.language_product.specification">
              <a class="nav-link" :class="{ active: activeNav == 'specifications' }" href="javascript:void(0)"
                 @click="activeNav = 'specifications'" aria-controls="specifications" role="tab" data-bs-toggle="tab"
                 aria-expanded="true">{{
                  lang.specifications
                }}</a>
            </li>
            <li class="nav-item" role="presentation">
              <a class="nav-link" :class="{ active: activeNav == 'delivery' }" href="javascript:void(0)"
                 aria-controls="delivery" @click="fetchReviews" role="tab" data-bs-toggle="tab"
                 aria-expanded="true">{{ lang.reviews }}</a>
            </li>
          </ul>
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade"
              ...
              <div class="specifications">
                <iframe :src="productDetails.language_product.specification" height="842px"></iframe>
              </div
              ><!-- /.specifications -->
            </div>
            <div role="tabpanel" class="tab-pane fade" :class="{ 'show active': activeNav == 'delivery' }"
                 id="delivery">
                  ...
                  <li v-for="(review, index) in reviews.data" :key="'review' + index">
                    <div class="comment_info">
                      ...
                      <div class="selected-media mt-0 m-2" v-if="review.images">
                        <img loading="lazy" :src="review.image_link" :alt="productDetails.product_name"
                             class="img-thumbnail" width="100"/>
                      </div>
                      <div class="comment-icon">
                        <ul class="global-list" v-if="authUser">
                          <li v-if="alreadyLiked(review.review_likes)"
                          ><a href="javascript:void(0)" @click="unLike(review.id)"
                          ...
                          <li v-else
                          ><a href="javascript:void(0)" @click="reviewLike(review.id)"
                              :class="{ disable_btn: like_loading }">
                          ...
                          <li
                          ><a href="javascript:void(0)" @click="toggleReplyForm(review.id)"><span
                              class="mdi mdi-share"></span></a>
                          </li>
                          <li v-if="review.replies.length > 0"
                          ><a href="javascript:void(0)" @click="showReplies(review.id)"
                              class="font_18">{{ review.replies.length }} {{ lang.replies }}</a>
                          </li>
                        </ul>
                      </div>
                      <form @submit.prevent="reviewReply(review.id)" v-if="reply_form == review.id">
                        <div class="row">
                          ...
                          <div class="col-lg-9 pl-0">
                            <textarea v-model="product_form.reply" class="form-control reply_box" required="required"
                                      rows="2"></textarea>
                          </div>
                          <div class="col-lg-2">
              ...
              <div v-if="(authUser && !productDetails.user_review) || edit" class="review-form">
                ...
                <form @submit.prevent="submitReview">
                  <div class="form-group">
                    ...
                    <input class="form-control" v-model="product_form.title" name="name" type="text" value="" size="30"
                           aria-required="true" required="required"/>
                  </div>
                  <div class="form-group">
                    <label>{{ lang.comment }}</label>
                    <textarea name="message" v-model="product_form.comment" class="form-control" required="required"
                              rows="7"></textarea>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file d-flex">
                        ...
                        <label class="upload-image upload-text d-flex loader-bdr" for="upload-2">
                          ...
                          <img loading="lazy" :src="getUrl('public/images/others/env.svg')"
