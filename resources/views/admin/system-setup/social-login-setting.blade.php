                                ...
                                <div class="card-body col-md-10 middle">
                                    ...
                                    <form action="{{ route('social.login.update') }}" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="google_client_id" id="google_client_id" value="{{ old('google_client_id') ? old('google_client_id') : (config('app.demo_mode') ? Str::of(settingHelper('google_client_id'))->mask('*', 3, 25) : settingHelper('google_client_id')) }}" placeholder="{{ __('Google Client Id') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="google_client_secret" id="google_client_secret" value="{{ old('google_client_secret') ? old('google_client_secret') : (config('app.demo_mode') ? Str::of(settingHelper('google_client_secret'))->mask('*', 3, 25) : settingHelper('google_client_secret')) }}" placeholder="{{ __('Google Client Secret') }}">
                                ...
                                <div class="card-body col-md-10 middle">
                                    ...
                                    <form action="{{ route('social.login.update') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="facebook_client_id" id="facebook_client_id" value="{{ old('facebook_client_id') ? old('facebook_client_id') : (config('app.demo_mode') ? Str::of(settingHelper('facebook_client_id'))->mask('*', 3, 25) : settingHelper('facebook_client_id')) }}"  placeholder="{{ __('Facebook Client Id') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="facebook_client_secret" name="facebook_client_secret" value="{{ old('facebook_client_secret') ? old('facebook_client_secret') : (config('app.demo_mode') ? Str::of(settingHelper('facebook_client_secret'))->mask('*', 3, 25) : settingHelper('facebook_client_secret')) }} " placeholder="{{ __('Facebook Client Secret') }}">
