...
@section('title', __('Edit Warehouse Transfer'))
    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Edit Warehouse Transfer') }}</h2>
                    <p class="section-lead">
                        {{ __('Update transfer details') }}
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('transfers.update', $transfer->id) }}" method="POST" id="transferForm">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <select name="from_warehouse_id" id="from_warehouse_id" class="form-control select2" required>
                                                ...
                                                @foreach($warehouses as $warehouse)
                                                    <option value="{{ $warehouse->id }}" 
                                                        ...
                                                        {{ $transfer->from_warehouse_id == $warehouse->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="to_warehouse_id" id="to_warehouse_id" class="form-control select2" required>
                                                ...
                                                @foreach($warehouses as $warehouse)
                                                    <option value="{{ $warehouse->id }}" 
                                                        data-capacity="{{ $warehouse->storage_capacity }}"
                                                        {{ $transfer->to_warehouse_id == $warehouse->id ? 'selected' : '' }}>
                                                        {{ $warehouse->getTranslation('name', \App::getLocale()) }}
                                                    </option>
                                                @endforeach
                                            </select>
