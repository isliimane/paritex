    ...
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{  $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                ...
                <select class="form-control filter-categories-by-ajax filter-categories-by-ajax_{{ $content_count }} lang" name="popular_category_{{ $content_count }}[]" multiple
                        required>
    ...
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{  $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                ...
                <select class="form-control filter-categories-by-ajax filter-categories-by-ajax_{{ $content_count }} lang" name="top_category_{{ $content_count }}[]" multiple required>
                    <option value="">{{ __('Select Category') }}</option>
                    @if(@arrayCheck('top_category', $contents))
                        @php
                            $categories = \App\Models\Category::whereIn('id', $contents['top_category'])->get();
                        @endphp
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}"
                                    selected>{{ $category->getTranslation('title',app()->getLocale()) }}</option>
    ...
    <div class="drag-brop-menu content-{{ $content_count }}">
        <div class="menu-item card" data-id="{{  $content_count }}">
            ...
            <div class="card-body campaign-{{ $content_count }}">
                ...
                <div class="form-group">
                    <select class="form-control filter-categories-by-ajax filter-categories-by-ajax_{{ $content_count }} lang" name="category_section_{{ $content_count }}_category"
                            required>
                        <option value="">{{ __('Select Category') }}</option>
