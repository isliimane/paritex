    ...
    public function up()
    {
        ...
        $roles = [
            [
                ...
                "role_update","role_delete","language_create","language_read","language_update","language_delete",
                ...
                "product_restore","product_clone",
                "support_create","support_read","support_update","support_delete","support_department_create","support_department_read","support_department_update","support_department_delete",
                "order_create","order_read","order_update","order_view","order_delete","order_invoice",
                ...
                "email_setting_update","currency_setting_update","vat_tax_setting_update","storage_setting_update","cache_update","miscellaneous_setting_update","admin_panel_setting_update",
                "pusher_notification_update","payment_gateway_read","payment_gateway_update",
                ...
                "campaign_product_read","campaign_product_update","campaign_product_delete","subscriber_read","subscriber_delete","coupon_read","coupon_create","coupon_update",
                ...
                "city_update","city_delete","admin_product_sale_read","product_stock_read","product_wishlist_read","user_searches_read","commission_history_read","wallet_recharge_history_read",
                "api_setting_update","android_setting_update","ios_setting_update","app_config_update","ads_config_update","download_link_update",
                "delivery_hero_read","delivery_hero_create","delivery_hero_update","delivery_hero_delete","delivery_hero_ban","Delivery_hero_account_deposit","delivery_hero_email_activation",
                ...
                "reward_setting_update","user_reward_read","user_reward_update","service_read","service_create","service_update",
            ...
            [
                ...
                "role_update","role_delete","language_create",
        ...
        $users = [
            [
                ...
                "role_read","role_update","role_delete",
                "language_create","language_read","language_update","language_delete","translation_message_update","media_create","media_read","media_update","media_delete",
                ...
                "product_read","product_update","product_delete","product_restore","product_clone",
                "support_create","support_read","support_update","support_delete","support_department_create","support_department_read","support_department_update",
                "support_department_delete","order_create","order_read","order_update","order_view","order_delete","order_invoice","pickup_hub_create","pickup_hub_read","pickup_hub_update",
                ...
                "storage_setting_update","cache_update","miscellaneous_setting_update","admin_panel_setting_update","pusher_notification_update",
                "payment_gateway_read","payment_gateway_update","theme_option_update","header_content_update","footer_content_update","home_page_update",
                ...
                "campaign_delete","campaign_request_read","campaign_request_approved","subscriber_read","subscriber_delete","campaign_product_create","campaign_product_read",
                ...
                "country_update","state_read","state_create","state_update","state_delete","city_read","city_create","city_update","city_delete","admin_product_sale_read","product_stock_read",
                ...
                "ads_config_update","download_link_update","delivery_hero_read","delivery_hero_create",
                ...
                "user_reward_update","service_read","service_create","service_update","service_delete","slider_read",
                ...
                "social_login_setting_update","pos_config_update","pos_order","api_key_create","api_key_update",
                "state_import_create","city_import_create", "seller_as_login",
                "subscription_setting_read","online_payment_read"]',
                'first_name' => 'Super',
                'last_name' => 'Admin',
                'user_type' => 'admin',
                'gender' => 'male',
